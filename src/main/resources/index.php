...
<html>
    ...
    <body>
        ...
        <h2>Ask a question Test</h2>
        
<?php
        $javaCommand ="java -jar";
	$dir ="/home/elahi/grammar/new/question-answering/";
        $jarFile ="target/QuestionGrammarGenerator.jar";
	$type ="search";
	$language ="EN";
	$questionFile ="src/main/resources/questions.txt";
	$tesStr ="\"Tell me\"";
	$givenToken ="Tell me";
	$tokenStr ="\"".$givenToken."\"";
	$space =" ";
	$command =$javaCommand.$space.$dir.$jarFile.$space.$type.$space.$language.$space.$dir.$questionFile.$space.$tokenStr;
